...
def retrieve_candidates(
    ...
    """Get candidate destination fields for a source field"""
    ...
    destination_fields = db.query(DestinationField).filter(
        DestinationField.dataset_id == dest_dataset.id
    ).all()
