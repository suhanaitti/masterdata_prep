...
class SourceField(Base):
    ...
    field_metadata_rel = relationship("FieldMetadata", back_populates="source_field", uselist=False, cascade="all, delete-orphan")
...
class FieldMetadata(Base):
    ...
    source_field = relationship("SourceField", back_populates="field_metadata_rel")
